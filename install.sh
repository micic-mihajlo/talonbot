...
WORKER_RUNTIME=${WORKER_RUNTIME:-inline}
WORKER_SESSION_PREFIX=${WORKER_SESSION_PREFIX:-dev-agent}
TMUX_BINARY=${TMUX_BINARY:-tmux}
WORKER_TMUX_POLL_MS=${WORKER_TMUX_POLL_MS:-500}
